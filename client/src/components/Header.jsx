...
export const Header = () => {
  ...
  return (
    <Navbar className='border-b-2'>
      ...
      >
        <span>
          <span className='px-2 py-1 bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-semiBold   text-center me-2 mb-2 rounded-lg text-white'>
            Virtual
          </span>
          Verse
        </span>
      ...
      <div className='flex gap-2 md:order-2'>
        <Button
          className='w-12 h-10 hidden  sm:inline justify-center items-center'
          color='gray'
          pill
